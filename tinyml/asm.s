...
;
.import _mnemcomp,_mnemcompz
.import list2,monz,getlnv,prntyx,crout,getnum,zmode,cout,bell
.export asm_entry
...
@procmnm:       and #$1F    ; ex.:  PHP                                            'P' = $50 -> $10
                ...
                ; go on to find the mnemonic in _mnemcomp table
                ; and then return this index to the opcode lookup tables
                ldx #.lobyte(_mnemcompz-_mnemcomp+1)
@firstfail:     dex
@scndfail:      dex
                bpl @cont
                jmp syntaxerr
@cont:          lda _mnemcomp,x     ; high
                cmp tmph
                bne @firstfail
                dex
                lda _mnemcomp,x     ; low
