...
namespace haiku6502 {
    Instruction operations[256] {
        ...
        Instruction(BBR1, ZERO_RELATIVE, 3, 5, P65C02),
        ...
        Instruction(RMB2, ZERO, 2, 5, P65C02),
        ...
        Instruction(BBR2, ZERO_RELATIVE, 3, 5, P65C02),

        // 0x30
        Instruction(BMI, RELATIVE, 2, 2),
        Instruction(AND, INDIRECT_INDEXED_Y, 2, 5),
        Instruction(AND, ZERO_INDIRECT, 2, 5, P65C02),
        Instruction(NOP, IMPLIED, 1, 2),
        Instruction(BIT, ZERO_INDIRECT, 2, 4, P65C02),
        Instruction(AND, ZERO_X, 2, 4),
        Instruction(ROL, ZERO_X, 2, 6),
        Instruction(RMB3, ZERO, 2, 5, P65C02),
        ...
        Instruction(BBR3, ZERO_RELATIVE, 3, 5, P65C02),
        ...
        Instruction(RMB4, ZERO, 2, 5, P65C02),
        ...
        Instruction(NOP, IMPLIED, 1, 2),
        Instruction(NOP, IMPLIED, 1, 2),
        Instruction(STZ, ZERO, 2, 3, P65C02),
        Instruction(ADC, ZERO, 2, 3),
        Instruction(ROR, ZERO, 2, 5),
        Instruction(RMB6, ZERO, 2, 5, P65C02),
        ...
        Instruction(BBR6, ZERO_RELATIVE, 3, 5, P65C02),

        // 0x70
        Instruction(BVS, RELATIVE, 2, 2),
        Instruction(ADC, INDIRECT_INDEXED_Y, 2, 5),
        Instruction(ADC, ZERO_INDIRECT, 2, 5, P65C02),
        Instruction(NOP, IMPLIED, 1, 2),
        Instruction(STZ, ZERO_X, 2, 4, P65C02),
        Instruction(ADC, ZERO_X, 2, 4),
        Instruction(ROR, ZERO_X, 2, 6),
        Instruction(RMB7, ZERO, 2, 5, P65C02),

        Instruction(SEI, IMPLIED, 1, 2),
        Instruction(ADC, ABSOLUTE_Y,3, 4),
        Instruction(PLY, IMPLIED, 1, 4, P65C02),
        Instruction(NOP, IMPLIED, 1, 2),
        Instruction(JMP, ABS_INDEXED_INDIRECT_X, 3, 6, P65C02),
        Instruction(ADC, ABSOLUTE_X, 3, 4),
        Instruction(ROR, ABSOLUTE_X, 3, 7),
        Instruction(BBR7, ZERO_RELATIVE, 3, 5, P65C02),

        // 0x80
        Instruction(BRA, IMPLIED, 2, 3, P65C02),
        ...
        Instruction(SMB2, ZERO, 2, 5, P65C02),
        ...
        Instruction(BBS3, ZERO_RELATIVE, 3, 5, P65C02),
        ...
        Instruction(SMB6, ZERO, 2, 5, P65C02),
