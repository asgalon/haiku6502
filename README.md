...
areas in hexadecimal bytes and a disassembler.
...
I stripped th graphics handling and modified the system routines to support the changed pseudo-hardware.
...
## The Emulator
The emulator is written in C++ in a CMake project structure. 
